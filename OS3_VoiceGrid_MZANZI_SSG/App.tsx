              ...
              <div className="flex flex-col h-full overflow-y-auto pb-20">
                ...
                <div className="grid grid-cols-2 gap-4 mt-6 mb-2">
                  <button
                    onClick={() => {
                      setIsSpeakerMuted(prev => {
                        const newState = !prev;
                        const player = document.getElementById('os3-audio-player') as HTMLAudioElement | null;
                        if (player) player.muted = newState;
                        return newState;
                      });
                    }}
                  ...
                  >
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">{!isSpeakerMuted ? 'SPEAKER: ON' : 'SPEAKER: OFF'}</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">{isListening ? 'MIC: LIVE' : 'MIC: OFF'}</span>
                  </button>
                </div>
